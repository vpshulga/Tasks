...
public class HomeWorkMain {
    public static void main(String[] args) {
        PrintAndReverseArray1.printArray(); // Task1
        FirstHundredNumbersDivByThirteenAndSeventeen2.divisionByThirteenAndSeventeen(); // Task2
        ...
        EqualsElementsFromTwoArrays6.equals(0, 1); // Task6
